...
import FileUpload from "admin/components/TechnologyFunds/FileUpload.js";
...
class TechnologyFundsForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      EditObject: {},
  ...
  Save = async (callback) => {
    ...
    formData.append(
      ...
      JSON.stringify({
        ...
        technology_type: this.ModifyObject["technology_type"],
      })
    );
...
export default withRouterAndRef(TechnologyFundsForm);
