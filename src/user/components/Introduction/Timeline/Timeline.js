...
const widgetStories = [
    ...
    body: (
      <div>
        <p>
          ...
          улаан булан, улаан гэр, кино зэрэг ажлыг удирдаж байжээ. Түүнээс хойш
          дараах нэршлээр нэрлэгдэж байсан байна.
        </p>
        <ul>
  ...
  },
  {
    ...
    badgeColor: "primary",
    badgeIcon: CardTravel,
    title: "ШИНЭ ҮЕИЙН БОЛОВСРОЛЫН ТОГТОЛЦОО БҮРЭЛДЭН ТОГТСОН НЬ ",
    titleColor: "primary",
    body: (
      <p>
  ...
  },
  {
    ...
    badgeColor: "success",
    badgeIcon: Extension,
    title: "СОЦИАЛИСТ БҮТЭЭН БАЙГУУЛАЛТЫН ҮЕ ",
    titleColor: "success",
    body: (
      <p>
  ...
  },
  {
    ...
    title: "АРДЧИЛАЛ НИЙГМИЙН ШИНЭЧЛЭЛИЙН ҮЕ ",
    titleColor: "warning",
    body: (
      <div>
        <p>
