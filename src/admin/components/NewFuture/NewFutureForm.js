...
import newFutureConfig from "config/objectConfigs/newFutureConfig";

import FileUpload from "admin/components/NewFuture/FileUpload.js";
...
class NewFutureForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      EditObject: {},
...
export default withRouterAndRef(NewFutureForm);
