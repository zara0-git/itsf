...
import customerConfig from "config/objectConfigs/customerConfig";

import MainImageUpload from "admin/components/Customer/MainImageUpload.js";
import OtherImagesUpload from "admin/components/Customer/OtherImagesUpload.js";
  ...
  Save = async (callback) => {
    ...
    formData.append(
      ...
      JSON.stringify({
        ...
        customer_type: this.ModifyObject["customer_type"],
      })
    );
...
export default withRouterAndRef(CustomerForm);
