...
class NewFutureGrid extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      Alert: null,
        ...
        <GridContainer>
          ...
          <GridItem xs={12} sm={6} md={6}>
            ...
            <Button
              ...
              splice={1}
              onClick={() => {
                History.push(`/admin/new-future/create`);
              }}
              style={{ marginRight: "5px" }}
            >
                    ...
                    <TableRow key={row.id} hover>
                      ...
                      <TableCell align="center">
                        <Button
                          ...
                          simple
                          onClick={() => {
                            History.push(`/admin/new-future/edit/` + row.id);
                          }}
                        >
                          <EditIcon
                            className={
...
export default withStyles(styles)(NewFutureGrid);
