...
class OurRulesGrid extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      Alert: null,
        ...
        <GridContainer>
          ...
          <GridItem xs={12} sm={6} md={6}>
            ...
            <Button
              ...
              splice={1}
              onClick={() => {
                History.push(`/admin/rules/${this.props.typeId}/create`);
              }}
              style={{ marginRight: "5px" }}
            >
                    ...
                    <TableRow key={row.id} hover>
                      ...
                      <TableCell align="center">
                        <Button
                          ...
                          onClick={() => {
                            History.push(
                              `/admin/rules/${this.props.typeId}/edit/` + row.id
                            );
                          }}
                        >
                          <EditIcon
...
export default withStyles(styles)(OurRulesGrid);
