...
import FileUpload from "admin/components/OurRules/FileUpload.js";
...
class OurRulesForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      EditObject: {},
  ...
  Save = async (callback) => {
    ...
    formData.append(
      ...
      JSON.stringify({
        ...
        rules_type: this.ModifyObject["rules_type"],
      })
    );
...
export default withRouterAndRef(OurRulesForm);
